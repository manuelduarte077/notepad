...
/// @nodoc
abstract class _$$_GetAllNotesCopyWith<$Res> {
  factory _$$_GetAllNotesCopyWith(
          _$_GetAllNotes value, $Res Function(_$_GetAllNotes) then) =
      __$$_GetAllNotesCopyWithImpl<$Res>;
}

/// @nodoc
class __$$_GetAllNotesCopyWithImpl<$Res>
    extends _$HomeEventCopyWithImpl<$Res, _$_GetAllNotes>
    implements _$$_GetAllNotesCopyWith<$Res> {
  __$$_GetAllNotesCopyWithImpl(
      _$_GetAllNotes _value, $Res Function(_$_GetAllNotes) _then)
      : super(_value, _then);
}

/// @nodoc

class _$_GetAllNotes implements _GetAllNotes {
  const _$_GetAllNotes();
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$_GetAllNotes);
  }
...
class _$_Loaded implements _Loaded {
  const _$_Loaded(final List<Note> notes) : _notes = notes;
...
abstract class _Loaded implements HomeState {
  const factory _Loaded(final List<Note> notes) = _$_Loaded;
